...
-- User
INSERT INTO `leave_application_db`.`MT_USER` (`USER_ID`, `USERNAME`, `PASSWORD`, `EMPLOYEE_CODE`, `ACCOUNT_NON_EXPIRED`, `ACCOUNT_NON_LOCKED`, `CREDENTIALS_NON_EXPIRED`, `ENABLED`) VALUES ('U000000000', 'root', '$2a$10$PaMU6xG2CxfGj1jX60Ag.eqqNBvG7oKngtV6AWZYWSyuMmZcVSqTu', 'SYS_ADMIN', true, true, true, true);
